...
import ro.fundatiacomunitarabucuresti.volunteer.web.UserRoleController;

privileged aspect UserRoleController_Roo_Controller {
    
    @Autowired
    UserAccountService UserRoleController.userAccountService;
    ...
    public String UserRoleController.createForm(Model uiModel) {
        ...
        if (userAccountService.countAllUserAccounts() == 0) {
    ...
    void UserRoleController.populateEditForm(Model uiModel, UserRole userRole) {
        ...
        uiModel.addAttribute("useraccounts", userAccountService.findAllUserAccounts());
    }
