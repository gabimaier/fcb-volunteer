...
privileged aspect SkillIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    SkillService SkillIntegrationTest.skillService;
    
    @Test
    public void SkillIntegrationTest.testCountAllSkills() {
    ...
    public void SkillIntegrationTest.testFindSkillEntries() {
        ...
        List<Skill> result = skillService.findSkillEntries(firstResult, maxResults);
    ...
    @Test
    public void SkillIntegrationTest.testUpdateSkillUpdate() {
        Skill obj = dod.getRandomSkill();
        Assert.assertNotNull("Data on demand for 'Skill' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Skill' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifySkill(obj);
        Integer currentVersion = obj.getVersion();
        Skill merged = skillService.updateSkill(obj);
        obj.flush();
    ...
    @Test
    public void SkillIntegrationTest.testSaveSkill() {
        Assert.assertNotNull("Data on demand for 'Skill' failed to initialize correctly", dod.getRandomSkill());
    ...
    @Test
    public void SkillIntegrationTest.testDeleteSkill() {
        Skill obj = dod.getRandomSkill();
        Assert.assertNotNull("Data on demand for 'Skill' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Skill' failed to provide an identifier", id);
        obj = skillService.findSkill(id);
        skillService.deleteSkill(obj);
        obj.flush();
        Assert.assertNull("Failed to remove 'Skill' with identifier '" + id + "'", skillService.findSkill(id));
    }
